...
public class RigidChipTrimF extends RigidChipTrim
{
	public int getType(){ return TYPE_TRIMF; }
	public String getTypeString(){ return "TrimF"; }
	...
	protected void drawMain(jVLDevice device)
	{
		...
		{	// triangle
			makeTriangle(new float[]{0.0f, 0.1f, -0.1f}, new float[]{0.1f, 0.27f, 0.27f}, new float[]{0.5f, 0.65f, 0.35f}, new float[]{0.7f, 0.95f, 0.95f});
